...
$StartMessage = 'Démarrage du programme d''installation de jgrep…'
$RootError = 'Le programme d''installation commun est introuvable. Exécutez ce script depuis le paquet d''installation jgrep vérifié.'
