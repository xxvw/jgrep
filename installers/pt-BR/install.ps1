...
$StartMessage = 'Iniciando o instalador do jgrep…'
$RootError = 'O instalador comum não foi encontrado. Execute este script a partir do pacote de instalação verificado do jgrep.'
