...
$StartMessage = 'Avvio del programma di installazione di jgrep…'
$RootError = 'Il programma di installazione comune non è stato trovato. Esegui questo script dal pacchetto di installazione verificato di jgrep.'
