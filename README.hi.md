...
`v0.1.1` रिलीज़ रिपॉज़िटरी का नाम बदलने से पहले की है, इसलिए उसके अपरिवर्तनीय आर्काइव और इंस्टॉलर डायरेक्टरी के नाम अब भी `localjev-grep` से शुरू होते हैं। रिपॉज़िटरी URL, मौजूदा स्रोत और इंस्टॉल किया गया कमांड `jgrep` नाम का उपयोग करते हैं।
...
## Codex टोकन बेंचमार्क

कोड स्थान खोजने वाले तीन नियंत्रित कार्यों के बेंचमार्क में `jgrep --ai -F`
ने `rg -F` की तुलना में **16.4% कम कुल Codex टोकन** इस्तेमाल किए। कैश न किए
गए इनपुट टोकन 54.9% और खोज-टूल का आउटपुट 97.1% कम हुआ। यह केवल एक बार का
रन है, सामान्य गारंटी नहीं। दो कार्यों में स्थान समान थे; व्यापक कार्य में
`rg` पक्ष के Codex उत्तर ने कच्चे टूल आउटपुट में मौजूद एक स्थान छोड़ दिया।

[कार्यप्रणाली और सीमाएँ](benchmark/README.md), [परिणाम सारांश](benchmark/RESULTS-2026-09-22.md), [हर रन का डेटा](benchmark/results/2026-09-22.json) और [कच्चे निष्पादन लॉग](benchmark/logs/2026-09-22/README.md) देखें।
